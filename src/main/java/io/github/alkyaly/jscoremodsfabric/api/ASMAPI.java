package io.github.alkyaly.jscoremodsfabric.api;
...
public final class ASMAPI {
    ...
    public static String mapMethod(String owner, String name, String desc) {
        return map(Coremod.TargetType.METHOD, owner, name, desc);
    }

    public static String mapField(String owner, String name, String desc) {
        return map(Coremod.TargetType.FIELD, owner, name, desc);
    }

    public static String mapClass(String clazz) {
        return map(Coremod.TargetType.CLASS, clazz, null, null);
    }

    public static String map(Coremod.TargetType target, String owner, String name, String desc) {
        return Target.map(target, owner, name, desc);
    }
     ...
     * @param name The name of the old method node. You may want to use {@link #mapMethod(String, String, String)} if this is a srg name
    ...
    public static void log(String level, String message, Object... args) {
        JsCoremodsFabric.LOGGER.log(Level.getLevel(level), message, args);
    }
